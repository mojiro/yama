...
"""Yama: Uploads files and directories to remote host using SFTP.
<ansible.modules.remote_management.yama.sftp_upload>"""
...
def main():
    ...
    if device.connect():
        unreachable = 0
        result = device.upload(module.params['local'], module.params['remote'])
